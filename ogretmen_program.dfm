    ...
    object QRBand1: TQRBand
      ...
      object QRMemo1: TQRMemo
        ...
        Lines.Strings = (
            ...
            's'#305'navlar'#305'nda g'#246'revlendirildiniz.Bu ama'#231'la a'#351'a'#287#305'daki g'#252'n ve saatl' +
            'erde okulumuzda '
          
            'haz'#305'r bulunman'#305'z'#305', herhangi bir sebeple gelemeyece'#287'iniz g'#252'nler i' +
            #231'in mazeretinizi '
          'belgeleriyle birlikte okul idaresine vermenizi rica ederim.'
          
            '       Komisyon '#252'yelerinin s'#305'nav saatinden 60 dakika '#246'nce g'#246'zetm' +
            'enlerin s'#305'nav '
          'saatinden 30 dakika '#246'nce okulda haz'#305'r bulunmalar'#305' gerekmektedir.')
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
