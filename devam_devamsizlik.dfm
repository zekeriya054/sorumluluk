object devam_devamsizlik_f: Tdevam_devamsizlik_f
  Left = 333
  Top = 234
  Width = 870
  Height = 500
  Caption = 'DEVAM DEVAMSIZLIK'
  Color = clBtnFace
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'rogrami,dersler where sinav_programi.tarih=:tarih and  sinav_pro' +
        'grami.ders_kodu=dersler.ders_kodu order by sinav_programi.tarih ' +
        'asc,sinav_programi.saat asc,dersler.ders_adi asc')
    Left = 728
    Top = 16
    ParamData = <
      item
